...
function MobileApp() {
  return (
    ...
    <div className="bg-primary-brand-color flex justify-between items-center bg-mobile-app container mx-auto mt-7 rounded-lg text-white">
      <div className="flex flex-col gap-y-3 p-10 ">
       <h3 className="text-2xl font-bold tracking-tight">Getir'i indirin!</h3>
       <p className="font-semibold">İstediğiniz ürünleri dakikalar içinde kapınıza</p>
